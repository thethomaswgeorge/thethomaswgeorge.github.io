...
<div class="project-box" id="wishful" style="background-image: url('New Project (8).png')">
    ...
    <div id="footer">
        <div class="center-div center">
            <small>Copyright &copy; <?php echo date("Y"); ?> | Created and Owned by Thomas George | Fonts by <a href="fonts.google.com" target="_blank" title="Google Fonts">Google Fonts</a> | Icons by <a href="https://fontawesome.com/" target="_blank" title="FontAwesome">FontAwesome</a> | Stock Image by <a href="https://www.pexels.com/photo/close-up-of-computer-keyboard-248515/" target="_blank" title="Pexels">Pexels</a> <i onclick="darkMode()" class="fas fa-moon moon-darkmode"></i></small>
        </div>
    </div>
</div>
</body>
